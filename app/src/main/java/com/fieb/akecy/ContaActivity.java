    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icNovos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ContaActivity.this, NovosActivity.class);
        ...
        icPromocoes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ContaActivity.this, PromocoesActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        icPesquisar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ContaActivity.this, PesquisarActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        icFavoritos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ContaActivity.this, FavoritosActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
