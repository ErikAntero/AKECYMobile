    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icNovos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PromocoesActivity.this, NovosActivity.class);
        ...
        icFavoritos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PromocoesActivity.this, FavoritosActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
        ...
        icConta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PromocoesActivity.this, ContaActivity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        });
